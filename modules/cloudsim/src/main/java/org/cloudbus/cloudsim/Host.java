...
public class Host {
	...
	public void addMigratingInVm(Vm vm) {
		...
		if (!getVmsMigratingIn().contains(vm)) {
			...
			if (!getVmScheduler().allocatePesForVm(vm, vm.getCurrentRequestedMips())) {
				Log.printLine("Here -> [VmScheduler.addMigratingInVm] Allocation of VM #" + vm.getId() + " to Host #"
	...
	public String toString() {
		return "Host [id=" + id + ", storage=" + storage + ", ramProvisioner=" + ramProvisioner + ", bwProvisioner="
