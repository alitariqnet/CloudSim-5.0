...
public class Simulation1 {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting Simulation1..");
//		String name = "Datacenter1";
		try {
			...
			// create a datacenter
			Datacenter dc1 = createDatacenter("datacenter1",10);
			// create a broker
...
//        	//Fifth step: Create two Cloudlets
        	...
        	Log.printLine("----------------------------------------------");
        	Log.printLine("Simulation1 finished!");
